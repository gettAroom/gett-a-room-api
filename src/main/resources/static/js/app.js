...
var scanSplash = exports.scanSplash = {
  ...
  ["$log", "RestSrv", function Ctrl($log, RestSrv) {
    ...
    Object.assign(splashCtrl, { $log: $log });
...
var NotAvailableCtrl = function () {
	/* @ngInject */
	NotAvailableCtrl.$inject = ["$scope", "$log", "RestSrv", "$stateParams"];
	function NotAvailableCtrl($scope, $log, RestSrv, $stateParams) {
			...
			this.$mdDialog.show({
				controller: function () {
					...
					function Ctrl($mdDialog) {
						...
						Object.assign(roomSuccessCtrl, { $mdDialog: $mdDialog });
					}
			...
			this.$mdDialog.show({
				controller: function () {
					...
					function Ctrl($mdDialog) {
						...
						var infoCtrl = this;
						Object.assign(infoCtrl, { $mdDialog: $mdDialog });
					}
		...
		value: function reserveCountdown(ev) {
			this.$mdDialog.show({
				...
				["$mdDialog", "$state", "moment", function Ctrl($mdDialog, $state, moment) {
					...
					Object.assign(reserveCtrl, { $mdDialog: $mdDialog, $state: $state });
				}],
				locals: {
					room: this.room
				},
			...
			this.$mdDialog.show({
				controller: function () {
					...
					function Ctrl($mdDialog, $state, moment, $mdMedia) {
						...
						Object.assign(notAvilableCtrl, { $mdDialog: $mdDialog, $state: $state, $mdMedia: $mdMedia });
						this.moment = moment;
